...
balt ~/Dokumentumok/dspace-angular/src/app/item-page/simple/field-components/specific-field/generic/generic-item-page-field.component.ts
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 47 - ((28 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 47
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 156 - ((9 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 156
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 5367 - ((20 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 5367
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 5543 - ((21 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 5543
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 149 - ((4 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 149
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 22 - ((4 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 22
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 35 - ((18 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 35
...
lcd ~/Dokumentumok/dspace-angular
tabnext
edit ~/Dokumentumok/dspace-angular/src/themes/bme/app/navbar/navbar.component.html
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
set winwidth=1
argglobal
if bufexists("~/Dokumentumok/dspace-angular/src/themes/bme/app/navbar/navbar.component.html") | buffer ~/Dokumentumok/dspace-angular/src/themes/bme/app/navbar/navbar.component.html | else | edit ~/Dokumentumok/dspace-angular/src/themes/bme/app/navbar/navbar.component.html | endif
balt ~/Dokumentumok/dspace-angular/src/themes/bme/app/navbar/navbar.component.html
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
lcd ~/Dokumentumok/dspace-angular
tabnext
edit ~/Dokumentumok/dspace-angular/src/themes/bme/app/navbar/navbar.component.ts
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
set winwidth=1
argglobal
if bufexists("~/Dokumentumok/dspace-angular/src/themes/bme/app/navbar/navbar.component.ts") | buffer ~/Dokumentumok/dspace-angular/src/themes/bme/app/navbar/navbar.component.ts | else | edit ~/Dokumentumok/dspace-angular/src/themes/bme/app/navbar/navbar.component.ts | endif
balt ~/Dokumentumok/dspace-angular/src/themes/bme/app/navbar
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
tabnext 4
set stal=1
badd +0 ~/Dokumentumok/dspace-angular/angular.json
badd +0 ~/Dokumentumok/dspace-angular/src/themes/eager-themes.module.ts
badd +0 ~/Dokumentumok/dspace-angular/config/config.dev.yml
...
badd +0 ~/Dokumentumok/dspace-angular/src/themes/bme/app/item-page/full/full-item-page.component.html
...
badd +0 ~/Dokumentumok/dspace-angular/src/themes/bme/app/item-page/simple/item-types/untyped-item/untyped-item.component.ts
